...
st.subheader("Welcome to my the alcohol sales prediction app using HPsklearn")


st.write("""
# Explore different Regression models for the IOWA dataset . Which one is the best ?
""")

model_name = st.sidebar.selectbox(
    'Select Model',
    ('Random Forest Regressor', 'XGBoost Regressor', 'KNN Regressor')
)

st.write(f"## {model_name} Model Type")
